...
class session {
    function __construct() {
        ...
        // This line prevetns unexpected effects when using objects as save handlers.
    ...
    function start_session($session_name, $secure) {
        ...
        // Now we cat the start session.
        session_start();
        // This line regenerates the session and delete the old one.
        // It also generates a new encyption key in the database.
